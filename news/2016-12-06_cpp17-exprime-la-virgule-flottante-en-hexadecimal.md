...
Les plus beaux jeux de mots seront récompensés avec des cadeaux de la part de *LinuxFr.org*. Alors vous ne savez pas quoi faire de votre journée ? Fait comme les *Nerdettes* (les deux filles sur l'illustration), bogue du cerveau et propose ton code source de folie pour tenter de remporter un des lots.
...
* Le code source doit être sous licence libre (pense à bien faire figurer la licence de ton choix) ;
...
* Les vainqueurs un livre à choisir parmi ceux des éditions Eyrolles et ENI ;
